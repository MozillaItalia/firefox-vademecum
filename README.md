...
Nei prossimi capitoli vedremo di spiegarti perché come usare Firefox, ti consiglieremo le migliori estensioni per personalizzare il tuo browser, scoprirai altri progetti portati avanti da Mozilla e infine parleremo della missione che portiamo avanti come comunità.
...
##### Ublock
Una versione più leggera e migliore di ADBlock, impedisce il caricamento delle pubblicità e velocizza la navigazione. Mostra le statistiche sia delle risorse bloccate sia delle pubblicità bloccate nella pagina che si sta visitando. 
